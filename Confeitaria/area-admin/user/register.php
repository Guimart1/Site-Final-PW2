<?php 
  ...
  if(!empty($_POST)){
    $id_User = $AdminDao['idAdm'];
    $nome_User =  $AdminDao['nomeAdm'];
    $sobrenome_User = $AdminDao['sobrenomeAdm'];
    $cpf_User = $AdminDao['cpfAdm'];
    $nasc_User= $AdminDao['dataNascAdm'];
    $email_User = $AdminDao['emailAdm'];
    $password_User = $AdminDao['senhaAdm'];
    $imagem_User = $AdminDao['fotoAdm'];
    }else{
      $nome_User = '';
      $sobrenome_User = '';
      $cpf_User = '';
